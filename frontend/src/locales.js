const translations = {
  ru: {
    ...
    archive: 'В архив',
    you: 'Вы',
    ticketClosed: 'Заявка закрыта',
    statusArchived: 'В архиве',
    errorReopening: 'Ошибка открытия',
    errorArchiving: 'Ошибка архивации',
    ...
    selectTicket: 'Выберите заявку для просмотра',
    ...
    send: 'Отправить',
    cancel: 'Отмена',
    ticketTitle: 'Тема заявки',
    ticketDesc: 'Опишите проблему...',
    statusOpen: 'Открыта',
  ...
  en: {
    ...
    errorReopening: 'Error reopening',
    ...
    selectTicket: 'Select ticket to view',
    ...
    ticketDesc: 'Describe the problem...',
    statusOpen: 'Open',
